...
HD_PWD='C:/Users/ysfyi/Desktop/pldlab_project/q_7/q_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log q7_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source q7_top.tcl

...
HD_PWD='C:/Users/ysfyi/Desktop/pldlab_project/q_7/q_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log q7_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source q7_top.tcl -notrace
